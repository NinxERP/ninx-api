...
{
    /// <inheritdoc />
    public partial class AjustaLayoutAssinaturaCredorTemplates : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.UpdateData(
                ...
                keyValue: "TermoCompromisso",
                column: "ConteudoHtml",
                value: TemplateTermoCompromissoNovo);

            migrationBuilder.UpdateData(
                table: "DocumentosTemplate",
                keyColumn: "TipoDocumento",
                keyValue: "ReciboPagamentoParcial",
                column: "ConteudoHtml",
                value: TemplateReciboPagamentoParcialNovo);

            migrationBuilder.UpdateData(
                table: "DocumentosTemplate",
                keyColumn: "TipoDocumento",
                keyValue: "ReciboQuitacaoGlobal",
                column: "ConteudoHtml",
                value: TemplateReciboQuitacaoGlobalNovo);
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.UpdateData(
                ...
                keyValue: "TermoCompromisso",
                column: "ConteudoHtml",
                value: TemplateTermoCompromissoAntigo);
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: "ReciboPagamentoParcial",
                column: "ConteudoHtml",
                value: TemplateReciboPagamentoParcialAntigo);
        ...
        private const string EstiloComumAntigo = """
            @page { size: A4; margin: 35px 45px; }
            body { font-family: Helvetica, Arial, sans-serif; color: #1E293B; font-size: 10pt; }
            h1 { font-size: 20pt; color: #0D1B2A; margin: 0 0 4px 0; }
            .subtitulo { font-size: 10pt; color: #0EA5E9; font-weight: bold; letter-spacing: 1px; margin-bottom: 25px; }
        ...
        private const string TemplateTermoCompromissoAntigo = """
            <!DOCTYPE html>
            <html><head><meta charset="utf-8" /><style>
            """ + EstiloComumAntigo + """
            </style></head>
        ...
        private const string TemplateReciboPagamentoParcialAntigo = """
            <!DOCTYPE html>
            <html><head><meta charset="utf-8" /><style>
            """ + EstiloComumAntigo + """
            </style></head>
        ...
        private const string TemplateReciboQuitacaoGlobalAntigo = """
            <!DOCTYPE html>
            <html><head><meta charset="utf-8" /><style>
            """ + EstiloComumAntigo + """
            </style></head>
